...
describe('Screen op', function() {
    ...
    describe('#updateBufferAndAccumulate()', function() {
	it('should return all steps of buffer updates', function() {
	    const b = ["line1"],
		  commands = [
		      [ "il", 1],
		      [ "ic", [1, 0], "a new happy line!!" ],
		  ...
		  expected = [
		      ["line1"],
		      ["line1", ""],
		      ["line1", "a new happy line!!"],
		      ["a new happy line!!"],
		      ["a new happy line!!", ""],
		      ["a new happy line!!", "another happy line??"],
		      ["a new happy line", "!!", "another happy line??"],
		      ["a new happy line", "!!", "another happy line", "??"],
		      ["a new happy line", "!!another happy line", "??"]
		  ];
	    expect(so.updateBufferAndAccumulate(commands, b)).to.eql(expected);
	});
    });
});
